  ...
  return (
    <footer className="bg-primary text-primary-foreground">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <img src="/logo-sekolah.png" alt="Logo SMA PGRI 4" className="w-10 h-10 object-contain" />
              <span className="font-display font-bold text-lg">SMA PGRI 4 PALEMBANG</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="opacity-80">085609301662</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-4 h-4 shrink-0 text-accent" />
                <span className="opacity-80">SMAGRIFOURPLG@GMAIL.COM</span>
              </div>
            </div>
          </div>
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="container py-5 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm opacity-70">
          <span>© {new Date().getFullYear()} SMA PGRI 4 PALEMBANG. Semua hak dilindungi.</span>
          <div className="flex items-center gap-4">
            {/* WhatsApp */}
            <a
              href="https://wa.me/6285609301662"
              target="_blank"
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/smapgri4_plg?igsh=MWdjbmpnMjZobHZ0aQ=="
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-primary-foreground/10 flex items-center justify-center hover:bg-accent hover:text-accent-foreground transition-all duration-200"
