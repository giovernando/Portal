...
export const prestasiData: PrestasiItem[] = [
  {
    ...
    imgSrc: mathImg,
    deskripsi: [
      "Ahmad Fauzan kembali mengharumkan nama Sekolah Nusantara dengan meraih medali emas pada Olimpiade Matematika tingkat Nasional tahun 2024. Kompetisi yang diikuti oleh ribuan siswa dari seluruh penjuru Indonesia ini sangat ketat dengan bobot soal bertaraf internasional.",
  ...
  },
  {
    ...
    imgSrc: roboImg,
    deskripsi: [
      "Tim ekstrakurikuler Robotik Sekolah Nusantara menyandang gelar Juara 2 di kompetisi inovasi robot tingkat provinsi Jawa Tengah. Mereka berhasil membuat prototipe robot pengantar obat otonom yang dapat menavigasi lorong-lorong sempit menggunakan sensor ultrasonik.",
  ...
  },
  {
    ...
    deskripsi: [
      ...
      "Di pertandingan final, Dimas sukses menekuk perwakilan dari sekolah juara bertahan berkat stamina dan pukulan smash kerasnya. Dimas rutin berlatih 4 kali seminggu semenjak bergabung bersama unit kegiatan olahraga Sekolah Nusantara.",
  ...
  },
  {
    ...
    imgSrc: englishImg,
    deskripsi: [
      "Putri Amelia membuktikan bahwa kefasihan lisan dapat sejalan dengan kemampuan berpikir logis. Membawa bendera Sekolah Nusantara, Putri dinobatkan sebagai Juara 3 lomba Debat Bahasa Inggris se-Provinsi yang diikuti oleh lebih dari 50 tim.",
  ...
  },
  {
    ...
    imgSrc: tariImg,
    deskripsi: [
      "Festival Seni Budaya Pelajar menobatkan Tim Tari Sekolah Nusantara sebagai penampil terbaik dan meraih Juara 1 dalam kategori Tari Tradisional. Tim yang berisikan 12 seniman muda berbakat ini membawakan Tari Saman yang rampak dan penuh energi.",
  ...
  },
  {
    ...
    imgSrc: writeImg,
    deskripsi: [
      "Sinta Dewi berhasil mencetak sejarah emas bagi kemampuan literasi siswa Sekolah Nusantara setelah karyanya memenangkan juara kedua dalam Lomba Cerpen Remaja Nasional (LCRN) 2023.",
  ...
  },
  {
    ...
    deskripsi: [
      ...
      "Semenjak kemenangan ini, ekstrakurikuler beladiri di Sekolah Nusantara bertambah pesat peminat dari kelas baru."
    ]
  },
  {
    ...
    tahun: "2022",
    tingkat: "Provinsi",
    siswa: "Sekolah Nusantara",
    kategori: "lainnya",
    imgSrc: adiwiyataImg,
    deskripsi: [
      "Sekolah Nusantara memperoleh plakat Penghargaan Sekolah Adiwiyata Tingkat Provinsi dari Kementerian Lingkungan Hidup dan Kehutanan, sebagai pengakuan atas komitmen tinggi pada lingkungan.",
  ...
  },
  {
    ...
    deskripsi: [
      ...
      "Banyak yang kagum dan hal tersebut membuat minat para siswa baru sangat kuat untuk lolos seleksi tim paduan suara unggulan Sekolah Nusantara berikutnya."
    ]
  },
  {
