...
export const beritaData: BeritaItem[] = [
  {
    ...
    date: "15 Maret 2025",
    img: studentsImg,
    excerpt: "Pendaftaran PPDB tahun ajaran baru telah resmi dibuka. Segera daftarkan putra-putri Anda untuk bergabung dengan SMA PGRI 4 Palembang.",
    content: [
      "SMA PGRI 4 Palembang dengan bangga mengumumkan bahwa proses Penerimaan Peserta Didik Baru (PPDB) untuk tahun ajaran 2025/2026 telah resmi dibuka. Pendaftaran ini ditujukan bagi calon siswa yang ingin menempuh pendidikan di salah satu instansi terbaik dengan fasilitas modern.",
      ...
      "Orang tua murid diharapkan segera melengkapi berkas persyaratan sebelum kuota terpenuhi. Mari bersama-sama mencetak generasi penerus bangsa yang unggul, berprestasi, dan berakhlak mulia di SMA PGRI 4 Palembang."
    ]
  },
  {
    ...
    content: [
      "Prestasi membanggakan kembali ditorehkan oleh siswa SMA PGRI 4 Palembang. Pada ajang Olimpiade Sains Nasional (OSN) tingkat provinsi, delegasi sekolah berhasil menyabet medali emas di bidang Fisika terapan.",
  ...
  },
  {
    ...
    content: [
      "Sejalan dengan misi menjadi sekolah unggulan berbasis teknologi, SMA PGRI 4 Palembang telah menyelesaikan renovasi total ruang laboratorium komputer. Kini, lab tersebut dilengkapi dengan 40 unit komputer teranyar bertenaga tinggi.",
  ...
  },
  {
    ...
    content: [
      "Untuk memastikan keselarasan pengajaran dengan standar terbaru dari Kementerian Pendidikan, seluruh jajaran staf pengajar SMA PGRI 4 Palembang mengikuti workshop intensif bertajuk Implementasi Kurikulum Merdeka.",
  ...
  },
  {
    ...
    content: [
      "Hari Guru Nasional diperingati dengan sukacita oleh seluruh elemen di SMA PGRI 4 Palembang. Para pengurus OSIS mengambil inisiatif menyusun upacara khusus serta rentetan acara hiburan untuk memberikan apresiasi bagi seluruh pahlawan tanpa tanda jasa di kampus kita.",
